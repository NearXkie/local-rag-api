...
async def query_rag(request: QueryRequest):
    ...
    "2. If the provided context does not contain the answer, you must say exactly: 'I cannot answer this based on the provided context.' and stop.\n"
    "3. Every factual claim in your response must end with an inline citation, formatted as [Source: filename, Page: X].\n"
    "4. A claim with no supporting context must not appear in the answer.\n\n"
    f"Context:\n{context}\n\n"
